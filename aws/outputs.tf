...
output "k8s_master_auth_client_certificate" {
  value = "${azurerm_kubernetes_cluster.k8sexample.kube_admin_config.0.client_certificate}"
}

output "k8s_master_auth_client_key" {
  value = "${azurerm_kubernetes_cluster.k8sexample.kube_admin_config.0.client_key}"
}

output "k8s_master_auth_cluster_ca_certificate" {
  value = "${azurerm_kubernetes_cluster.k8sexample.kube_admin_config.0.cluster_ca_certificate}"
}
